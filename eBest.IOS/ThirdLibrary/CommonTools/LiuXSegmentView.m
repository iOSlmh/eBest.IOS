...
#define SFQRedColor RGB(32, 179, 169, 1)
...
-(instancetype)initWithFrame:(CGRect)frame titles:(NSArray *)titleArray andIndex:(NSInteger)statePage andImageArr:(NSArray *)imageArr clickBlick:(btnClickBlock)block{
    ...
    if (self) {
        ...
        _titles=titleArray;
        _defaultIndex=statePage;
        _titleFont=[UIFont systemFontOfSize:UNIT_HEIGHT(15)];
        _btns=[[NSMutableArray alloc] initWithCapacity:0];
        _titleNomalColor=RGB(71, 71, 71, 1);
