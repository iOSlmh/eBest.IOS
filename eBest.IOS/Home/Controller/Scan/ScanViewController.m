...
@interface ScanViewController ()<AVCaptureMetadataOutputObjectsDelegate,UIAlertViewDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
-(void)setupTipTitleView{
    ...
    //2.操作提示
    UILabel * tipLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, SH*0.9-kBorderW*2, SW, kBorderW)];
...
-(void)setupNavView{
    ...
    albumBtn.center=CGPointMake(SW/2, 20+49/2.0);
    ...
    flashBtn.frame = CGRectMake(SW-55,20, 35, 49);
...
- (void)setupMaskView
{
    ...
    mask.bounds = CGRectMake(0, 0, SW + kBorderW + kMargin , SW + kBorderW + kMargin);
    mask.center = CGPointMake(SW * 0.5, SH * 0.5);
    mask.sd_y = 0;
...
{
    //1.下边栏
    UIView *bottomBar = [[UIView alloc] initWithFrame:CGRectMake(0, SH * 0.9, SW, SH * 0.1)];
    ...
    myCodeBtn.frame = CGRectMake(0,0, SH * 0.1*35/49, SH * 0.1);
    myCodeBtn.center=CGPointMake(SW/2, SH * 0.1/2);
...
{
    CGFloat scanWindowH = SW - kMargin * 2;
    CGFloat scanWindowW = SW - kMargin * 2;
