...
-(id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        topView.backgroundColor = RGB(251, 251, 251, 1);
        ...
        numLabel.textColor = RGB(175, 175, 175, 1);
        ...
        [addBtn setTitleColor:RGB(51, 51, 51, 1) forState:UIControlStateNormal];
        ...
        styleLabel.textColor = RGB(102, 102, 102, 1);
