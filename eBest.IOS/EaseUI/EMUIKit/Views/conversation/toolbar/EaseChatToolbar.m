...
- (void)_setupSubviews
{
    ...
    [styleChangeButton setImage:[UIImage imageNamed:@"danliaoMic"] forState:UIControlStateNormal];
    [styleChangeButton setImage:[UIImage imageNamed:@"danliao键盘"] forState:UIControlStateSelected];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"danliao表情"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"danliao表情"] forState:UIControlStateHighlighted];
    [self.faceButton setImage:[UIImage imageNamed:@"danliao键盘"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"danliao加"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"danliao加"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"danliao键盘"] forState:UIControlStateSelected];
