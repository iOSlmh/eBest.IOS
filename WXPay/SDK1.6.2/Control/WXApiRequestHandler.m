...
+ (NSString *)jumpToBizPay:(NSDictionary *)orderDict {
        ...
        if ( response != nil) {
            ...
            if(dict != nil){
                ...
                if (retcode.intValue == 0){
                    ...
                    req.partnerId           = [orderDict objectForKey:@"partnerid"];
                    req.prepayId            = [orderDict objectForKey:@"prepayid"];
                    req.nonceStr            = [orderDict objectForKey:@"noncestr"];
                    req.timeStamp           = [[orderDict objectForKey:@"timestamp"] intValue];
                    req.package             = [orderDict objectForKey:@"package"];
                    req.sign                = [orderDict objectForKey:@"sign"];
                    [WXApi sendReq:req];
