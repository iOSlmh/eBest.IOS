//
//  ReturnLogisticsViewController.m
//  eBest.IOS
//
...
@interface ReturnLogisticsViewController ()

@end

@implementation ReturnLogisticsViewController
...
-(void)loadData{
    ...
    [RequestTools posUserWithURL:@"/return_ship_edit.mob" params:dic success:^(NSDictionary *Dict) {
